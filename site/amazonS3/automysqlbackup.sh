...
BACKUPDIR="/var/www/vhosts/s3mer.com/private/backups/mysql"
...
PREBACKUP="pushd /var/www/vhosts/s3mer.com/httpdocs/amazonS3/; php clean_asrunlog.php $BACKUPDIR/asrunlog;popd"

# Command run after backups (uncomment to use)
POSTBACKUP="pushd /var/www/vhosts/s3mer.com/httpdocs/amazonS3/; php autos3upload.sh $BACKUPDIR/latest/s3mer_[2w]*.gz;popd"
